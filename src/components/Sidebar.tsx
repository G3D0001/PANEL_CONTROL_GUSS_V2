...
export function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  const xtvItems = [
    { to: "/xtv?menu=crear_directo", label: "Crear Línea Nueva", icon: Sparkles, permission: 'Iptv.Acceder' },
    { to: "/xtv?menu=renovaciones", label: "Renovaciones", icon: Rotate3d, permission: 'Iptv.Acceder' },
    { to: "/xtv?menu=mis_clientes", label: "Mis Clientes", icon: User, permission: 'Iptv.Acceder' },
    { to: "/xtv?menu=finanzas", label: "Solicitudes & Créditos", icon: ReceiptText, permission: 'Iptv.Acceder' },
        ...
        <nav className="flex-1 flex flex-col gap-1.5 overflow-y-auto pr-2 -mr-3 custom-scrollbar">
          ...
          {canShowSystem && (
            <div className="flex flex-col">
              ...
              >
                {/* Al tocar el texto/icono: navega a Usuarios & Perfiles en Ajustes y despliega el acordeón */}
                <NavLink
                  to="/configuracion?tab=users"
                  onClick={() => {
