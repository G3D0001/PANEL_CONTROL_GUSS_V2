  ...
  const filteredAccounts = useMemo(() => {
    ...
    if (!canSeeAll) {
      ...
      list = accounts.filter((a) => {
        ...
        // Caso 1: Es dueño por ID de usuario
        if (currentUserId && (accUserId === currentUserId || creadoPorLower === currentUserId)) {
          return true;
        }

        // Caso 2: Es dueño por nombre de usuario / cuenta
            ...
            (() => {
              ...
              const allCommissionRows = accounts
                ...
                .map((acc: any) => {
                  ...
                  // Determinación de comisiones según plan (Multinivel)
                  ...
                  // Verificación de Actividad del Vendedor en los últimos 30 días respecto a la fecha de la venta
                  ...
                  // Contar ventas del vendedor en esa ventana previa de 30 días
                  ...
                  // Si tiene al menos 1 venta (incluyendo la actual), está activo (100%), de lo contrario pasivo (50%)
                        ...
                        <table className="w-full text-left border-collapse text-xs">
                          <thead>
                            <tr className="bg-slate-50 dark:bg-slate-800/80 text-slate-500 font-extrabold uppercase tracking-wider text-[10px] border-b border-slate-200 dark:border-slate-700">
                              ...
                              <th className="p-3">Cliente / Línea</th>
                              <th className="p-3">Contacto</th>
                              <th className="p-3">Estado</th>
                              <th className="p-3">Vencimiento</th>
                              <th className="p-3 text-right">Acciones</x��XKs�8��W`s��ʏM�mݸ��������dh
�9�H�������zEVj�n<" ��#h���
:����]4�Du�ؙ�6�cf�g���,+a������b8� b�~�'}7�u����آ��:(�$,�&��ӏ��\�+i,��:�L�Xa0G�dw+�\$N���k�� ��{�!�>\=*�?x���ͭ��ڔ�<�"4��̠�MZ���m�%G�\��Q�{�L��"�?����c��j�z2[���/J�f	��XͤV(r+mΎ���O����U��ŵ9m�֋�f�K�nR2ė��gj}|œ�c4�>��'��Q�z���� /	��veA�j\���0��S�P�^d�7�1���Ї	|N�M{�k���Fn��dDE2S:B]��b�=�_$��(d$*���\��L���JzAR�i�t�*���˫�����k�' ��e��y�kp?�><נUL���2J�0QRA�6SqT�����*޹�a),z�"���Ƚ:7}�TV�Jf�J�?Ά��v`�����f@.�T^��F��Xx�Ր����n�rE��w �r�����YD�eܪ;L���D/��D���%�d��r��^���t�P�e8��J�t�:KSԜ��Q7J' ���0�ʸb)|�5�����m#�.z'X�TX@cY�`JGS�on�J��L�4&�Y�~W��������սϸ:�Ze�l�~VH��<���x�h�_�J)�і�����,s�MP����x�=;W=�N��
	���TYub��@q��ñ/s�2k�/wQ�~_��[�m�෌�t3*:��n�:Ӛ��̂3zS+Ʃ�GsF�_h�a�����)%eŶ���Q��j{�z��娦�x�n��na��|z�!c!1�;8j�S^?`�R�ӳ����5���񝎘�x��Ѻ�&O��}���@����%�s�ҽ��2���8l��,�C
��s��nw�i��yل}�)�k�Y��,٦<��Х!�u�k %P�!$*q�3��TG�w ^�90�Sq+W�~а��E)�e�����   �� ��;�